...
<div class="container">
	...
	<c:if test="${not empty requestScope.flashMessage}">
		<div class="alert alert-success text-center">
			<c:out value="${requestScope.flashMessage}"/>  <%--예약 정보가 수정되었습니다 --%>
														   <%--예약이 취소되었습니다. --%>
		</div>
	</c:if>
	<c:choose>
					...
					<div class="card">					
						...
						<div class="car-body">
							...
							<div class="flex gap-2 mt-4">
								...
								<%-- 예약 수정 : 수정 화면(중앙화면 CarConfirmUpdate.jsp VIEW) CarController로 요청 --%>
								...
								<%-- 예약 취소 :  예약 취소시 비밀번호 재확인을 위해 입력하는 (중앙화면 VIEW) CarController로 요청 --%>
